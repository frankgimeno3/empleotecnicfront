  ...
  return (
    <div className="bg-white  shadow-lg p-3 pt-2 mt-2">
      ...
      <p className="text-gray-700 mb-2" style={{ fontSize: "0.70rem" }}>
        Estamos buscando un operario de fábrica para unirse a nuestro equipo de
        extrusión de aluminio industrial. Si tienes experiencia previa en el
        manejo de maquinaria y estás buscando un trabajo dinámico y desafiante,
      ...
      <ul className="text-gray-700 mb-2" style={{ fontSize: "0.65rem" }}>
        ...
        <li>
          Beneficios: Seguro médico, bonificaciones trimestrales, oportunidades
          de crecimiento
        </li>
        <li>
      ...
      <div>
        ...
        <ul className="text-gray-700 mb-2" style={{ fontSize: "0.60rem" }}>
          <li>
            <span className="font-bold">Antonio Recio,</span> 48, Barcelona,
            Extrusor
          </li>
          <li>
            <span className="font-bold">Matías Gimeno,</span> 26, Barcelona,
            Operario
          </li>
          <li>
            <span className="font-bold">Juan Recio, </span> 35, Lleida, Extrusor
          </li>
          <li>
            <span className="font-bold">Marivel Gimeno</span> , 33, Valladolid,
            Extrusor
          </li>
          <li>
            <span className="font-bold">Mohammed Ayoub</span> , 26, Melilla,
            Operario
          </li>
        </ul>
      </div>
