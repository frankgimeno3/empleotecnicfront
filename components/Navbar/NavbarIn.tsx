...
const NavbarIn: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-cyan-950 bg-opacity-50 backdrop-filter backdrop-blur-lg flex items-center justify-between px-4 py-2 md:text-xs xl:text-base">
      <button
