...
export default function Dashboard() {
  ...
  return (
    <div style={{ margin: '0 20vw' }}>
      <div className="mt-20 display-flex flex-row mx-auto">
        {isSMorMD && (
          <div className="relative" ref={menuRef}>
            ...
            {showMenu && (
              <div className="absolute top-0 left-0 bg-white border border-gray-300">
                <button
                  className={`p-5 bg-white button-menu ${selectedButton === 'Notificaciones' ? 'bg-gray-300' : ''}`}
                  onClick={() => handleButtonClick('Notificaciones')}
                >
                  Notificaciones
                </button>
                <button
                  className={`p-5 bg-white button-menu ${selectedButton === 'BolsaDeEmpleo' ? 'bg-gray-300' : ''}`}
                  onClick={() => handleButtonClick('BolsaDeEmpleo')}
                >
                  Bolsa de Empleo
                </button>
                <button
                  className={`p-5 bg-white button-menu ${selectedButton === 'MisOfertas' ? 'bg-gray-300' : ''}`}
                  onClick={() => handleButtonClick('MisOfertas')}
                >
                  Mis Ofertas
                </button>
                <button
                  className={`p-5 bg-white button-menu ${selectedButton === 'PublicarOferta' ? 'bg-gray-300' : ''}`}
                  onClick={() => handleButtonClick('PublicarOferta')}
                >
                  Publicar Oferta
                </button>
                <button
                  className={`p-5 bg-white button-menu ${selectedButton === 'ProcesosActivos' ? 'bg-gray-300' : ''}`}
        ...
        {!isSMorMD && (
          <div className='display-flex '>
            <button
              className={`p-5 ${selectedButton === 'Notificaciones' ? 'bg-gray-300' : 'bg-white'}`}
              onClick={() => handleButtonClick('Notificaciones')}
            >
              Notificaciones
            </button>
            <button
              className={`p-5 ${selectedButton === 'BolsaDeEmpleo' ? 'bg-gray-300' : 'bg-white'}`}
              onClick={() => handleButtonClick('BolsaDeEmpleo')}
            >
              Bolsa de Empleo
            </button>
            <button
              className={`p-5 ${selectedButton === 'MisOfertas' ? 'bg-gray-300' : 'bg-white'}`}
              onClick={() => handleButtonClick('MisOfertas')}
            >
              Mis Ofertas
            </button>
            <button
              className={`p-5 ${selectedButton === 'PublicarOferta' ? 'bg-gray-300' : 'bg-white'}`}
              onClick={() => handleButtonClick('PublicarOferta')}
            >
              Publicar Oferta
            </button>
            <button
              className={`p-5 ${selectedButton === 'ProcesosActivos' ? 'bg-gray-300' : 'bg-white'}`}
              onClick={() => handleButtonClick('ProcesosActivos')}
            >
              Procesos activos
            </button>
